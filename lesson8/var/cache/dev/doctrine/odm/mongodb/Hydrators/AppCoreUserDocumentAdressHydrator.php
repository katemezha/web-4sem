 ...
 */
class AppCoreUserDocumentAdressHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate(object $document, array $data, array $hints = array()): array
    {
        ...
        if (isset($data['user'])) {
            ...
            if ($this->class->fieldMappings['user']['storeAs'] !== ClassMetadata::REFERENCE_STORE_AS_ID && ! is_array($reference)) {
                throw HydratorException::associationTypeMismatch('App\Core\User\Document\Adress', 'user', 'array', gettype($reference));
            }
